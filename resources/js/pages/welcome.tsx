    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                ...
                {/* ── Button Showcase ─────────────────────────────── */}
                <div className="w-full max-w-[335px] lg:max-w-4xl mt-10 mb-4">
                    <div className="rounded-lg bg-white p-6 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:bg-[#161615] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                        <h2 className="mb-1 font-medium text-[#1b1b18] dark:text-[#EDEDEC]">
                            Button variants
                        </h2>
                        <p className="mb-6 text-[13px] text-[#706f6c] dark:text-[#A1A09A]">
                            All available button styles for this application.
                        </p>

                        <div className="mb-6">
                            <p className="mb-3 text-[11px] font-semibold uppercase tracking-wider text-[#706f6c] dark:text-[#A1A09A]">
                                Primary actions
                            </p>
