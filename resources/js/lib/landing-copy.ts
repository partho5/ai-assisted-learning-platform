...
const bn: LandingCopy = {
    ...
    hero: {
        badge: 'মুখস্ত নির্ভর নয়, skill ভিত্তিক Career',
        titleStatic: '২০ বছরের সার্টিফিকেট নয়।',
        titleGradient: '২ বছরের রিয়েল স্কিল।',
        subtitle: 'এখানে না বুঝে মুখস্থের কোন মূল্য নেই। কে রিয়েল লাইফে কত value create করতে পারে, তার ভিত্তিতেই পেশা এবং আয় নির্ধারিত হয়।',
        cta: 'কোর্স কারিকুলাম দেখুন',
        note: 'প্রাথমিকভাবে জয়েন করতে কোন টাকা লাগবে না',
    },
    trust: ['চাকরির চেয়ে আয় বেশি, কিন্তু ঝামেলা মুক্ত জীবন', 'টেকনোলজিতে আপডেট আসামাত্রই কোর্স আপডেট', 'পাবলিক স্কিল পোর্টফোলিও', 'AI-নেটিভ শেখা'],
    problem: {
        badge: 'কেন Jovoc',
        ...
        points: [
            ...
            {
                label: 'Passion is killed',
                body: 'যার যেটা মনে ভালো লাগে সেই অনুযায়ী পড়াশোনা চালিয়ে যাওয়ার ব্যবস্থা সীমিত কলেজ ইউনিভারসিটিতে। Jovoc এ অনেকগুলো স্কিল ট্রাই করুন, যেটাতে মন লেগে যায় সেটাতে ক্যারিয়ার সেট করুন।',
            },
            {
                label: 'চাকরিতে পদ সংখ্যা সীমিত',
                body: 'কিন্তু skill ভিত্তিক কাজে চাকরির মত পদ সংখ্যা সীমিত নয়। যদি ১ কোটি মানুষ skilled হতে পারে , তবে এক কোটি মানুষই দারুণ ক্যারিয়ার গড়তে পারে।',
            },
            {
                label: 'Discontent (অতৃপ্তি)',
                body: 'চাকরি না পেলে কতটা খারাপ লাগে বেকার কে জিজ্ঞেস করুন। আর চাকরি পাওয়ার পর কি পরিমান অতৃপ্তি - চাকরিজীবীদের জীবন সম্পর্কে খোঁজ নিয়ে দেখুন ! কারণ পছন্দের কাজ কেউ করছে না। সোসাইটির ধরিয়ে দেওয়া Tag কাঁধে নিয়ে চাকরি করছে।',
            },
        ],
        punchline: 'Jovoc Academy-র শিক্ষা ব্যবস্থা ঠিক তেমনটাই যেমনটা হওয়া উচিত',
        punchlineSub: 'এখানে মুখস্থের কোনো মূল্য নেই। কে রিয়েল লাইফে কতটা আউটপুট দিতে পারে তার ওপর ভিত্তি করেই তার ক্যারিয়ার গড়ে ওঠে।',
    },
    how: {
    ...
    timeline: {
        ...
        cards: [
            ...
            {
                title: 'শুধু চাকরি নয় — Your Own Business',
                body: 'সব শিক্ষার্থী চাকরি চান না। কেউ চান ক্লায়েন্ট, কেউ নিজের Business. এখানকার স্কিল দিয়ে দুটোই সম্ভব।',
            },
            {
    ...
    mentors: {
        ...
        cards: [
            ...
            },
            {
                ...
                body: 'কোর্স ফি নির্ধারণ করুন। চাইলে কুপন কোড ক্রিয়েট করতে পারেন।',
            },
        ],
    },
    pricing: {
    ...
    final: {
        headlineBefore: 'আপনার Next ',
        rotatingWords: ['ক্যারিয়ার', 'বিজনেস', 'ক্লায়েন্ট', 'আয়'],
        headlineAfter: ' শুরু হোক Jovoc থেকেই।',
        body: '',
